...
import CptCustomer_information from "./CptCustomer_information";
import CptCustomer_drawerAdd from "./CptCustomer_drawerAdd";

function CptCustomer(props) {
